...
var createTeamHandler = new CreateTeamHandler(playerProvider);
...
var simulateMatchHandler = new SimulateMatchHandler(matchSimulator);
...
var createTeamScreen = new CreateTeamScreen(createTeamHandler, playerProvider);
